...
```{r anomalies_from_annual_mean_trends_overview_key_biomes, fig.asp=1.5}
...
```{r anomalies_from_monthly_mean_trends_overview, eval=FALSE}
...
```{r anomalies_from_monthly_mean_trends_overview_key_biomes, fig.asp=1.5, eval=FALSE}
