...
```{r 2023_monthly_mean_maps, fig.asp=1.8, eval=FALSE}
...
```{r change_1990_2023_monthly_mean_maps, fig.asp=1.8, eval=FALSE}
...
```{r anomaly_2023_monthly_mean_maps, fig.asp=1.8, eval=FALSE}
