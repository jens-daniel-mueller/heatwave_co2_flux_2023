...
name_core <- c("fgco2", "fgco2_int", "fgco2_hov", "spco2", "sfco2", "wind", "temperature", "kw", "sol")
...
```{r anomalies_from_annual_mean_trends_overview, fig.asp=1.2}
...
```{r anomalies_from_annual_mean_trends_key_biomes_super, fig.asp=1.2}
...
```{r anomalies_from_annual_mean_trends_key_biomes, fig.asp=1.2}
