...
```{r anomaly_2023_annual_mean_maps, fig.asp=1}
...
```{r anomaly_2023_monthly_mean_maps, fig.asp=3}
...
```{r anomalies_correlation_absolute_global, eval=FALSE, fig.asp=1}
...
```{r anomalies_correlation_absolute_biome, eval=FALSE, fig.asp=1.8}
...
```{r anomalies_correlation_realtive_to_spread, eval=FALSE, fig.asp=1.8}
