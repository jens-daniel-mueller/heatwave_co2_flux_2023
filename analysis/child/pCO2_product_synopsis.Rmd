...
# pco2_product_monthly_detrended_anomaly_test <-
pco2_product_monthly_detrended_anomaly %>%
  filter(biome == "Global") %>%
  pivot_wider() %>%
...
```{r anomalies_correlation_absolute_monthly_biomes_super, fig.asp=1, eval=FALSE}
...
```{r anomalies_correlation_absolute_monthly_biomes_key, fig.asp=1.5, eval=FALSE}
