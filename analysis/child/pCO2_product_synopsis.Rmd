...
labels_breaks <- function(i_name) {
  ...
  if (i_name == "sfco2_total") {
    i_legend_title <- "fCO<sub>2,ocean</sub><br>total anomaly<br>(µatm)"
  }
  
  if (i_name == "sfco2_therm") {
    i_legend_title <- "fCO<sub>2,ocean</sub><br>thermal anomaly<br>(µatm)"
  }
  
  if (i_name == "sfco2_nontherm") {
    i_legend_title <- "fCO<sub>2,ocean</sub><br>non-thermal anomaly<br>(µatm)"
  }
  ...
  if (i_name == "resid_fgco2") {
    i_legend_title <-
      "FCO<sub>2</sub><br>observed<br>(mol m<sup>-2</sup> yr<sup>-1</sup>)"
  }
    
  if (i_name == "resid_fgco2_dfco2") {
    i_legend_title <-
      "FCO<sub>2</sub><br>ΔfCO<sub>2</sub><br>(mol m<sup>-2</sup> yr<sup>-1</sup>)"
  }
    
  if (i_name == "resid_fgco2_kw_sol") {
    i_legend_title <-
      "FCO<sub>2</sub><br>k<sub>w</sub> K<sub>0</sub><br>(mol m<sup>-2</sup> yr<sup>-1</sup>)"
  }
    
  if (i_name == "resid_fgco2_dfco2_kw_sol") {
    i_legend_title <-
      "FCO<sub>2</sub><br>k<sub>w</sub> K<sub>0</sub> X ΔfCO<sub>2</sub><br>(mol m<sup>-2</sup> yr<sup>-1</sup>)"
  }
    
  if (i_name == "resid_fgco2_sum") {
    i_legend_title <-
      "FCO<sub>2</sub><br>∑<br>(mol m<sup>-2</sup> yr<sup>-1</sup>)"
  }
    
  if (i_name == "resid_fgco2_offset") {
    i_legend_title <-
      "FCO<sub>2</sub><br>Obs. - ∑<br>(mol m<sup>-2</sup> yr<sup>-1</sup>)"
  }
...
```{r bivariate_anomaly_year_annual_mean_maps, fig.asp=1.5}
...
bi_legend <- bi_legend(pal = "DkViolet2",
...
pco2_product_coarse_annual_regression %>%
  ...
  map(
    ~ map +
      ...
      scale_fill_continuous_divergingx(palette = "RdBu", rev = TRUE, name = labels_breaks(.x %>% distinct(name))) +
...
```{r fCO2_decomposition_maps, fig.asp=1.5}
...
```{r flux_attribution_seasonal_maps, fig.asp=1.5}
