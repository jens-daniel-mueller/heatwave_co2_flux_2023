...
```{r {{year_anom}}_annual_mean_maps, fig.asp=0.5, results = FALSE}
...
```{r {{year_anom}}_change_annual_mean_maps, fig.asp=0.5, results = FALSE}
...
```{r {{year_anom}}_anomaly_annual_mean_maps, fig.asp=0.5, results = FALSE}
...
rm(pco2_product_coarse_annual_regression)
gc()
...
```{r {{year_anom}}_monthly_mean_maps, fig.asp=1.6, results = FALSE}
...
```{r {{year_anom}}_change_monthly_mean_maps, fig.asp=1.6, results = FALSE}
...
```{r {{year_anom}}_anomaly_monthly_mean_maps, fig.asp=1.6, results = FALSE}
...
```{r write_anomaly_anomaly_year_monthly_mean_maps, results = FALSE}

pco2_product_coarse_monthly_regression %>%
  # filter(year == {{year_anom}}) %>%
  write_csv(paste0("../data/","{{product_name}}","_","{{year_anom}}","_anomaly_map_monthly.csv"))

rm(pco2_product_coarse_monthly_regression)
gc()
...
```{r {{year_anom}}_hovmoeller_annual_anomaly, fig.asp=0.5, results = FALSE}
...
```{r {{year_anom}}_hovmoeller_monthly_anomalies, fig.asp=0.5, results = FALSE}
...
```{r {{year_anom}}_hovmoeller_monthly_anomalies_recent_years, fig.asp=0.5, results = FALSE}
...
rm(pco2_product_hovmoeller_monthly_regression)
gc()
...
```{r {{year_anom}}_absolute_means_and_integrals_overview_biomes_super, fig.asp=fig.height, eval=FALSE}
...
```{r {{year_anom}}_absolute_means_and_integrals_key_biomes_super, fig.asp=fig.height, eval=FALSE}
...
```{r {{year_anom}}_anomalies_from_annual_mean_trends_key_biomes_super, fig.asp=fig.height, eval=FALSE}
...
```{r {{year_anom}}_anomalies_from_monthly_mean_trends_biomes_super_overview, fig.asp=fig.height, eval=FALSE}
...
```{r {{year_anom}}_anomalies_from_monthly_mean_trends_biomes_super, fig.asp=fig.height, eval=FALSE}
...
```{r {{year_anom}}_anomalies_correlation_absolute_super_biome_monthly, fig.asp=0.5, eval=FALSE}
