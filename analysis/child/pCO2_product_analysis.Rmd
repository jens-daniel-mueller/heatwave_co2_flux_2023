...
```{r anomaly_year_monthly_mean_maps, fig.asp=1.6}
...
```{r change_1990_anomaly_year_monthly_mean_maps, fig.asp=1.6}
...
```{r anomaly_anomaly_year_monthly_mean_maps, fig.asp=1.6}
...
```{r absolute_global_means_and_integrals_global, fig.asp=fig.height}
...
```{r anomalies_from_monthly_mean_trends_global, fig.asp=fig.height}
...
```{r anomalies_from_monthly_mean_trends__key_biomes_overview, fig.asp=fig.height}
...
```{r anomalies_from_monthly_mean_trends_biomes_super_overview, fig.asp=fig.height}
...
```{r anomalies_from_monthly_mean_trends_biomes_super, fig.asp=fig.height}
