...
co2_mm_gl <- read_csv("/UP_home/jenmueller/Projects/heatwave_co2_flux_2023/data/co2_mm_gl.csv", 
    skip = 38)

global_co2_merged <- read_table("/UP_home/jenmueller/Projects/heatwave_co2_flux_2023/data/global_co2_merged.txt", 
    comment = "!",
